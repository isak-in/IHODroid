...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', '-m', default='Ho2vec', type=str, help='name of models')
    parser.add_argument('--task', '-t', default='node_classification', type=str, help='name of task')
    # link_prediction / node_classification
    parser.add_argument('--dataset', '-d', default='drebin', type=str, help='name of datasets')
    parser.add_argument('--gpu', '-g0', default='0', type=int, help='-1 means cpu')
