...
from .utils import sparse_mx_to_torch_sparse_tensor, load_drebin_mal
...
class HIN_NodeClassification(NodeClassificationDataset):
    ...
    def load_HIN(self, name_dataset):
        ...
        elif name_dataset in ['drebin']:
            g, category, num_classes = load_drebin_mal(False)

            # Metapath2vec
            # self.meta_paths_dict = {
            #     'APA': [('app', 'aat', 'activity'), ('activity', 'ata', 'app')],
            # }
            # self.meta_paths = [(('app', 'aat', 'activity'), ('activity', 'ata', 'app'))]
